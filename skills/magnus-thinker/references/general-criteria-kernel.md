...
| U2 | Las skills operativas son **HERRAMIENTAS de Magnus, nunca sistemas que lo reemplacen**. Activar una skill NO suprime el pipeline always-on de Magnus: context pull, **Paso 0 (enfoque/objetivo ANTES de producir + derivar/validar estructura)**, análisis, **Paso 4 (loop de convergencia en L2/L3)** y aprendizaje siguen corriendo. La skill solo aporta proceso de dominio + criterios (pills) + ruta del producto; Magnus sigue gobernando y orquestando. Cada SKILL.md debe declararlo arriba ("corre BAJO Magnus, no lo reemplaza"). Señal de falla: seguir el flujo de la skill y saltarse el Paso 0 o el loop "porque estoy en modo skill" — y dejar que el usuario cace lo que el loop debía atrapar. | TODA activación de skill operativa (presentaciones, notion, n8n, docs, sheets, vps, etc.) | sesión refactor vertical presentaciones 2026-06-15 | 2026-06-15 |
