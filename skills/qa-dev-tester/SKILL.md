...
**Regla de verificación:** el QA tester es quien simula ser el usuario, no el usuario quien prueba que el QA tester hizo bien su trabajo. Agotar toda verificación automatizada antes de pedir test manual. El usuario solo valida experiencia real (cómo se ve, cómo llega) — nunca diagnostica si el workflow corre.
